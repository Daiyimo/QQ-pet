...
- 运行方式：`cd /e/project/QQ_pet && npx electron test/ruffleSmoke/run.js`
...
| 4 | `QQ_pet/src/assets/Action/GG/Adult/happy/Stand.swf` | 老素材对照组（CWS v12, 含 DoABC） | 140x140 | ✅ | ✅ | 老素材本身也含 DoABC，一直由该 Ruffle 播放 |
...
目录 `E:/project/QQ_pet/test/ruffleSmoke/shots/`：
